...
class EmpresaConfigController {
  ...
  /**
   * Render a form to be used for creating a new empresaconfig.
   * GET empresaconfigs/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Render a form to update an existing empresaconfig.
   * GET empresaconfigs/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
